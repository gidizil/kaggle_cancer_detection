...
# 3. setting seeds and parameters:
SetSeeds.seed_torch()
NUM_WORKERS = class_config.set_num_workers()

# 4A. Build Dataset and DataLoader for training
train_set = CancerDataset(path_dict['pickle_train'], tr_labels_dict, tr_images_list)
...
val_set = CancerDataset(path_dict['pickle_val'], val_labels_dict, val_images_list)
