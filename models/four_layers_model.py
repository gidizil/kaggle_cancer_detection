...
""" ================================ """
""" An upgrade from the two layer    """
""" model. Input for this model will """
""" be a cropped and resized images  """
""" ================================ """
...
class Net(nn.Module, ModelUtils):
    def __init__(self, **kwargs):
        ...
        # Handling initial values and values that handle None
        ...
        self.conv2_bn_2d = nn.BatchNorm2d(32)
        self.conv3 = nn.Conv2d(32, 64, 5)
        self.conv3_bn_2d = nn.BatchNorm2d(64)
        self.conv4 = nn.Conv2d(64, 128, 3)
        self.conv4_bn_2d = nn.BatchNorm2d(128)
    ...
    def forward(self, x):
        ...
        x = self.conv3(x)
        x = self.conv3_bn_2d(x)
        x = F.relu(x)
        x = self.pool(x)

        x = self.conv4(x)
        x = self.conv4_bn_2d(x)
        x = F.relu(x)
        x = self.pool(x)
